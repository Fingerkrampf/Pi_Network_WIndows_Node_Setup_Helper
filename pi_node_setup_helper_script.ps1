...
VER 2025-05-02  (komplett automatisiertes Installationsskript für den Betrieb eines Pi Network Windows Nodes + IPv4 Lösung in Verbindung mit einem vServer, PS-5-kompatibel)
